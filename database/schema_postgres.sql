...
-- =============================================
DROP TABLE IF EXISTS conta_financeira CASCADE;
...
-- =============================================
DROP TABLE IF EXISTS meta_financeira CASCADE;
...
-- =============================================
DROP TABLE IF EXISTS telegram_vinculos CASCADE;
...
DROP VIEW IF EXISTS vw_saldo_conta CASCADE;
...
DROP VIEW IF EXISTS vw_resumo_categoria_mes CASCADE;
